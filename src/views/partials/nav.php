        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            <div>
              ...
              <?php else : ?>
                <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'bg-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Register</a>
                <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'bg-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Login</a>
              <?php endif; ?>
